/* Case study 1: Using Database AdventureWorksDW2020, table dbo.FactInternetSales 
Write a query that'll query Rention Cohort Analysis based on First time Customer Purchase in the p	eriod of Jan 2020 to Jan 2021*/ 
...
ORDER BY FirstPurchaseMonth ;
 ...
 /* Case study 2: Using Database AdventureWorksDW2020, table dbo.FactInternetSales
